...
const animationIn: Animation = 'fadeIn';
const animationOut: Animation = 'fadeOut';
...
export const CommonDialogAnimationConfig = {
  ...
  backdropOpacity: Platform.select({ios: 0.1, android: 0.02}),
};
...
export const CommonBottomSheetAnimationConfig = {
  ...
  hideModalContentWhileAnimating: true,
  useNativeDriver: false,
  backdropOpacity: Platform.select({ios: 0.1, android: 0.01}),
};
